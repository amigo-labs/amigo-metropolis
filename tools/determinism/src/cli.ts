...
//
//   bun tools/determinism/src/cli.ts record <script> <out.mrep> [seed]
//   bun tools/determinism/src/cli.ts write-hashes <replay.mrep> <out.hashes.json>
//   bun tools/determinism/src/cli.ts verify <replay.mrep> <expected.hashes.json>
//   bun tools/determinism/src/cli.ts verify-goldens
//
